...
array_lengths.push( findLongestWord( ["Real Madrid", "Barcelona", "Chelsea", "Manchester"] ) );
array_lengths.push( findLongestWord( ["LaLiga", "Serie A", "Premier"] ) );
...
{
	modified_array = array.sort(function(a,b) {
	    a = a.toString();
	    b = b.toString();
